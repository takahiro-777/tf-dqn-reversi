...
class Reversi:
    ...
    def __init__(self):
        ...
        self.Black = 1
        self.White = 2
        self.screen_n_rows = 6
        self.screen_n_cols = 6
    ...
    def reset(self):
        ...
        self.set_cells(14, self.White)
        self.set_cells(15, self.Black)
        self.set_cells(20, self.Black)
        self.set_cells(21, self.White)
    ...
    def put_piece(self, action, color, puton=True):
        ...
        """ ---------------------------------------------------------
           ...
           (0と0のペアは除く)。
        """
        t, x, y, l = 0, action%6, action//6, []
        for di, fi in zip([-1, 0, 1], [x, 5, 5-x]):
            for dj, fj in zip([-6, 0, 6], [y, 5, 5-y]):
